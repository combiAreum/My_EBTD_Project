    ...
    <header>
        ...
        <nav class="navdiv">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="menudetail"><a style="text-decoration: none;" href="getUserList">이용자 상세</a></div>
                    <div class="menudetail"><a style="text-decoration: none;" href="geUserHistoryList">이용자 전체 히스토리</a></div>
